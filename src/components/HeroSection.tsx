...
export const HeroSection = ({ onStartChat }: HeroSectionProps) => {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navigation */}
      <nav className="p-6 glass-card m-4 rounded-2xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 bg-gradient-to-r from-[hsl(var(--cyber-purple))] to-[hsl(var(--cyber-blue))] rounded-lg flex items-center justify-center">
              <Sparkles className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl font-bold gradient-text">CareerAI Guide</span>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-[hsl(var(--cyber-purple)/0.3)] to-[hsl(var(--cyber-blue)/0.3)] rounded-3xl blur-xl"></div>
            <img 
              src={heroImage} 
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">
              Why Choose <span className="gradient-text">CareerAI Guide</span>?
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-card p-8 hover:scale-105 transition-all duration-300 cyber-border">
            ...
            <Card className="glass-card p-8 hover:scale-105 transition-all duration-300 cyber-border">
              <div className="w-12 h-12 bg-gradient-to-r from-[hsl(var(--cyber-green))] to-[hsl(var(--cyber-blue))] rounded-lg flex items-center justify-center mb-6">
